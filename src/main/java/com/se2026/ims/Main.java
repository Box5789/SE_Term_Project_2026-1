...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            Repository<User> userRepo = new JsonRepository<>(dataDir + "users.json", User.class);
            Repository<Project> projectRepo = new JsonRepository<>(dataDir + "projects.json", Project.class);
            Repository<Issue> issueRepo = new JsonRepository<>(dataDir + "issues.json", Issue.class);
